...
//
//class ScenarioParserTest extends FlatSpec with Matchers with FeatureGenerator {
////  def suite = new ScenarioParser(fe`                                          ature).parse(Suite(name = "test"))
//  def emptySuite = feature(
//    """
...
////  override val featureFile = "/fixture.feature"
////}
////
...
////    cases(0).when should ===(Some("\"vinegar /tmp/vinegar/fixture.feature\" を実行する"))
...
////      """事前準備に以下が表示されていること:
////        |fixture.feature を /tmp/vinegar にコピーする
////        |/tmp/vinegar/fixture.feature を UTF-8 にする""".stripMargin))
////
...
////    cases(1).given should ===(None)
////    cases(1).when should ===(Some("\"vinegar -o ~/Desktop /tmp/vinegar/fixture.feature\" コマンドを実行する"))
